    ...
    <section className="py-[47px] xl:py-[70px] px-5 md:px-9 xl:px-[90px] relative overflow-hidden">
      <div className=" relative rounded-[15px] py-16 w-full px-[15px] md:px-16.5 flex  items-center aspect-1280/560">
        <div className="absolute left-0 top-0 w-full h-full rounded-[15px]">
          <Image
            src={"/jpgs/ctabanner.jpg"}
            alt="banner"
            fill
            className="object-cover rounded-[15px]"
          />
          <div className="w-full h-full bg-black/40 z-20 absolute rounded-[15px]"></div>
        </div>
        <div className="bg-white/80 z-20 rounded-[15px] max-w-[600px] px-[10px]  py-[25px] md:py-[67px] w-full flex flex-col gap-[21px] gap-12.5">
          ...
          <div className="w-full max-w-[480px] mx-auto flex flex-col gap-7.5 ">
            <Button className={"w-full"} ref={buttonRef}>
              Get Started
            </Button>
            <div className="flex gap-2.5 items-center justify-center text-[#64748B] text-[10px] md:text-[14px]" ref={textRef}>
